...
<body>
    ...
    <!-- Main Contents -->
    <main class="container motion" id="main-container" role="main">
		<article id="post-2273" class="post-2273 page type-page status-publish hentry">
        <div id="vs-main-search">
            <div class="home-top-background inner div-border">
                <!-- 1. 통합검색 -->
                <div id="sc-all">
        ...
        <div class="wpb_text_column wpb_content_element inner">
            <div class="wpb_wrapper">
                <div class="main-contents"><br>
                    <div class="main-tab">
                        <div class="main-tab-contents-outer div-border">
                            <p class="headline">도서관 소식</p>
                            <!-- 1. 개관시간 및 뉴스 -->
                            <div id="mc-notice" class="main-tab-content group">
    					        <div class="mps mod-content mps-default-wrap ">
    	                            <div class="mps-default">
    		                            <div class="mp-entry">
    ...
    <div class="vc_column-inner ">
        <div class="wpb_wrapper">
            <div class="wpb_text_column wpb_content_element ">
                <div class="wpb_wrapper">
        			<h3 class="off-screen">개관시간 및 뉴스</h3>
                    <div class="open-hour-box">
                        <h4>개관시간</h4>
                        <div class="mp-tab">
                            <div class="tab-head">
                                <ul class="tab-menu group">
                                    <li class="active"><a href="#tab-01">자료실</a></li>
                                    <li><a href="#tab-02">일반열람실</a></li>
                                </ul>
                            </div>
                            <div class="tab-body">
                                <div id="tab-01" class="tab-cont active">
                                    <h5 class="off-screen">자료실</h5>
                                    <ul class="open-hour-list">
                                        <li>
                                            <i class="fa fa-book"></i><p class="title">단행본실(중앙, 공학)</p><p class="content">월요일-금요일 : 09:00 ~ 21:00(학기중)</p>
                                        </li>
                                        <li>
                                            <i class="fa fa-file-text"></i><p class="title">연속간행물실(중앙,공학)</p><p class="content">월요일-금요일 : 09:00 ~ 21:00(학기중)</p>
                                        </li>
                                        <li>
                                            <i class="fa fa-camera"></i><p class="title">멀티미디어실</p><p class="content">월요일-금요일 : 09:00 ~ 18:00</p>
                                        </li>
                                    </ul>
                                </div>
                                <div id="tab-02" class="tab-cont">
                                    <h5 class="off-screen">일반열람실</h5>
                                    <ul class="open-hour-list">
                                        <li>
                                            <i class="fa fa-bookmark"></i><p class="title">중앙도서관 열람동 4층</p><p class="content">06:00 &#8211; 23:00</p>
                                        </li>
                                        <li>
                                            <i class="fa fa-wrench"></i><p class="title">공학도서관 1층, 2층</p><p class="content">일반 열람실 : 6:00 &#8211; 23:00</p>
                                        </li>
                                        <li>
                                            <i class="fa fa-pencil-square-o"></i><p class="title">학습도서관 3층(1~3), 4층(4~6열람실)</p>
                                            <p class="content">
                                            <strong>2열람실</strong><br />
                                            월수금 : 24시간 개방 / 화목토일 : 06:00 ~ 23:00<br />
                                            <strong>3열람실</strong><br />
                                            화목토일 : 24시간 개방 / 월수금 : 06:00 ~ 23:00<br />
                                            <strong>나머지</strong> : 06:00 &#8211; 23:00</p>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        <p><a class="ir img-main btn-more" href="/guide/time/">더보기</a></p>
                    </div>
    		    </div>
    	    </div>
        </div>
...
<div class="wpb_column vc_column_container vc_col-sm-4">
    <div class="vc_column-inner ">
        <div class="wpb_wrapper">
            <div class="wpb_text_column wpb_content_element ">
                <div class="wpb_wrapper">
    			    <div class="notice-faq-box">
                        <div class="notice-box">
                            <h4>공지사항</h4>
                            <p>
                                <ul>
                                    <li>
                                        <a href="https://libweb.pknu.ac.kr//board/notice/?pid=3429">2019학년도 독서후기 공모 및 권장도서 다독자 선발 안내</a><span class="date">2019.06.10</span>
                                    </li>
                                    <li>
                                        <a href="https://libweb.pknu.ac.kr//board/notice/?pid=3426">중앙도서관 리모델링에 따른 휴관안내</a><span class="date">2019.06.10</span>
                                    </li>
                                    <li>
                                        <a href="https://libweb.pknu.ac.kr//board/notice/?pid=3421">6월 도서관 신착자료 안내(도서&amp;전자책)</a><span class="date">2019.06.05</span>
                                    </li>
                                    <li>
                                        <a href="https://libweb.pknu.ac.kr//board/notice/?pid=3411">2019년 1학기 기말고사기간 일반열람실 24시간 개방 공고</a><span class="date">2019.06.05</span>
                                    </li>
                                    <li>
                                        <a href="https://libweb.pknu.ac.kr//board/notice/?pid=3407">신간 구입자료 중앙도서관 비치 안내</a><span class="date">2019.06.04</span>
                                    </li>
                                </ul><br/>
                                <a class="ir img-main btn-more" href="/board/notice/">더보기</a>
                            </p>
                        </div>
                        <div class="faq-box">
                            <h4>FAQ</h4>
                            <p>
                                <ul>
                                    <li>
                                        <a href="https://libweb.pknu.ac.kr//board/faq/?pid=911">공학도서관 자료 배달 신청</a><span class="date">2019.03.25</span>
                                    </li>
                                    <li>
                                        <a href="https://libweb.pknu.ac.kr//board/faq/?pid=2942">좌석배정기 시간</a><span class="date">2018.04.06</span>
                                    </li>
                                    <li>
                                        <a href="https://libweb.pknu.ac.kr//board/faq/?pid=909">자료 분실</a><span class="date">2017.01.08</span>
                                    </li>
                                    <li>
                                        <a href="https://libweb.pknu.ac.kr//board/faq/?pid=908">자료 연체</a><span class="date">2017.01.08</span>
                                    </li>
                                    <li>
                                        <a href="https://libweb.pknu.ac.kr//board/faq/?pid=907">자료 예약</a><span class="date">2017.01.08</span>
                                    </li>
                                </ul><br />
                                <a class="ir img-main btn-more" href="/board/faq/">더보기</a>
                            </p>
                        </div>
                    </div>
                </div>
