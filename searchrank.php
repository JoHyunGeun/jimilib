...
<article id="post-70" class="post-70 page type-page status-publish hentry page_tag-44" role="article">
		...
		<h1 class="entry-title">랭킹</h1>			</header><!-- .entry-header -->
	...
	<div class="entry-content group">
          ...
          $result = $conn->query("SELECT count(film_id) as cnt, film_id FROM rentalrecord group by film_id order by cnt desc");
          ...
          <td bgcolor="#cccccc">이번주 대여 횟수</td>
