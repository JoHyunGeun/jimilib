...
<article id="post-70" class="post-70 page type-page status-publish hentry page_tag-44" role="article">
		...
		<h1 class="entry-title">대여현황</h1>			</header><!-- .entry-header -->
	...
	<div class="entry-content group">
          ...
          $result = $conn->query("SELECT* FROM rental WHERE name like '$id%'");
          ...
          <td bgcolor="#cccccc">대여기간</td>
          <td bgcolor="#cccccc">대여요금</td>
