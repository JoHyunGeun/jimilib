...
<article id="post-70" class="post-70 page type-page status-publish hentry page_tag-44" role="article">
		...
		<h1 class="entry-title">도서관리</h1>			</header><!-- .entry-header -->
	...
	<div class="entry-content group">
          ...
          <form action="searchbookadcreate.php" method='post'>
          <table width="720" border="1" cellpadding="5">
              <tr><td> 도서번호 : <input type="text" size="6" name="id">&nbsp;
                       도서명 : <input type="text" size="3" name="title">&nbsp;

                       도서저자 : <input type="text" size="3" name="writer">&nbsp;
											  도서위치 : <input type="text" size="3" name="location">&nbsp;
           ...
           // select 문 수행
                ...
                $result = $conn->query("SELECT* FROM film ");
							...
							<td> $row[rating] </td>
											...
											<form id='query' action='searchbookdelete.php' method='post'>
											<input type='hidden' name='delete' id='delete' value=$row[film_id]>
					 					<td>  <input type='submit'  value='도서삭제'></td>
		                             </form>
						 					</tr>
